...
const messages = [
    ...
    "pencet lagi",
    "you are worth it always have been, always will you be. Worth more than.a billion galaxies ⸜(｡˃ ᵕ ˂ )⸝♡",
    "i loveeee u, i loveeee u everyday, i loveeee u every hour, i loveeee u every minute, i loveeee u every second, i loveeee u to the moon and back, i loveeee u the bottom of sea, i loveeee u every universe, i loveeee u more than, i lovee myself, i loveeee u more and more and u're the only one love ₍ᐢ. .ᐢ₎ ₊˚⊹♡",
    "akuuu gatauu mww bilang apalagii imupp",
    "terimakasiii yaaa imuppp",
    "aku cuma mau bilang",
    "ikan cucut nabrak curutt",
    "i love you imuppp ฅ^._.^ฅ",
    "bjiirlah",
    "coba pencet tombol dibawah ini imuppp 💝"
];
